 ...
 * @return {object} {h, s, v} values with h from 0 to 359 and s, v from 0 to 1
 */
 ...
 * @param {object} hsvTriple { h, s, v } values with h from 0 to 259 and s, v from 0 to 1
...
/**
 * Conversions from a hex RGB color to the equivalent HSV triplet happen often with the same hex
 ...
 * have fewer repeats, so the conversion from that to the equivalent hex color doesn't get cached.
